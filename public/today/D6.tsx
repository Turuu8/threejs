...
import { Image2, Image3, Image4, Image5, Image6 } from "@/pages";
...
export function D6Model(props: JSX.IntrinsicElements["group"]) {
  const { nodes, materials } = useGLTF("/today/sided6.glb") as GLTFResult;
  const arr = [
  ...
  return (
    <group {...props} dispose={null}>
      ...
      {/* <mesh />
      <mesh castShadow receiveShadow geometry={nodes.Circle001_2.geometry} material={materials["Material.002"]} />
      <mesh castShadow receiveShadow geometry={nodes.Circle001_3.geometry} material={materials["Material.003"]} />
      <mesh castShadow receiveShadow geometry={nodes.Circle001_4.geometry} material={materials["Material.004"]} />
      <mesh castShadow receiveShadow geometry={nodes.Circle001_5.geometry} material={materials["Material.005"]} />
      <mesh castShadow receiveShadow geometry={nodes.Circle001_6.geometry} material={materials["Material.006"]} /> */}
    </group>
  );
}

useGLTF.preload("/today/sided6.glb");
